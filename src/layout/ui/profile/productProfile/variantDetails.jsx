...
function VariantDetails() {
    ...
    if (!variant) {
        return <p className='text-text-color'>No variant</p>;
    }
                            ...
                            <div className="space-y-2 text-left">
                                <div className="grid grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <div className="p-2 bg-secondary-card rounded">{variant.name || 'N/A'}</div>
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium mb-1">Model</label>
                                        <div className="p-2 bg-secondary-card rounded">{variant.model || 'N/A'}</div>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <div className="p-2 bg-secondary-card rounded">{variant.productCode || 'N/A'}</div>
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium mb-1">HSN</label>
                                        <div className="p-2 bg-secondary-card rounded">{variant.HSN || 'N/A'}</div>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <div className="p-2 bg-secondary-card rounded">{variant.color || 'N/A'}</div>
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium mb-1">Size</label>
                                        <div className="p-2 bg-secondary-card rounded">{variant.size || 'N/A'}</div>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <div className="p-2 bg-secondary-card rounded">{variant.RFQ ? 'Yes' : 'No'}</div>
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium mb-1">Active</label>
                                        <div className="p-2 bg-secondary-card rounded">{variant.active ? 'Yes' : 'No'}</div>
                                    </div>
                                </div>
