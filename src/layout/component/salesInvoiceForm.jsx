    ...
    <div>
      <form onSubmit={handleSubmit}>
        ...
        <div className="w-full sm:w-1/2 p-4">
            <label className="block w-full mb-2 text-text-color">Invoice Status </label>
            <Select
...
<div className="w-full sm:w-1/2 p-4">
      ...
      />
          ...
          <div className="w-full sm:w-1/2 p-4">
            <label className="block w-full mb-2 text-text-color">Invoice Notes</label>
            <textarea
              name="invoiceNotes"
          ...
          <div className="w-full md:w-1/2 p-4">
            <label className="block w-full mb-2 text-text-color">Due-Date</label>
            <input
              type="date"
              id="dueDate"
