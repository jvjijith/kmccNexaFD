    ...
    <div className="overflow-x-auto min-h-96">
      <Table theme={{ dark: true }}>
        <Table.Head className="border-gray-700 bg-black text-white">
          ...
          <Table.HeadCell className="border-gray-700 bg-black text-white">Mode</Table.HeadCell>
          <Table.HeadCell className="border-gray-700 bg-black text-white">Primary Color</Table.HeadCell>
          <Table.HeadCell className="border-gray-700 bg-black text-white">Secondary Color</Table.HeadCell>
        ...
        <Table.Body className="divide-y">
          {colorData?.colorSchemes.map((scheme, index) => (
            <Table.Row key={index} className="border-gray-700 bg-zinc-950">
              ...
              <Table.Cell className="text-gray-300">{scheme.mode}</Table.Cell>
