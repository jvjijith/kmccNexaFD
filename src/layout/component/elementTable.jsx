    ...
    <div className="overflow-x-auto min-h-96">
      <Table theme={{ dark: true }}>
        <Table.Head className="border-gray-700 bg-black text-white">
          <Table.HeadCell className="border-gray-700 bg-black text-white">Component Type</Table.HeadCell>
          <Table.HeadCell className="border-gray-700 bg-black text-white">Reference Name</Table.HeadCell>
          <Table.HeadCell className="border-gray-700 bg-black text-white">Web Items</Table.HeadCell>
          <Table.HeadCell className="border-gray-700 bg-black text-white">Android Items</Table.HeadCell>
          <Table.HeadCell className="border-gray-700 bg-black text-white">iOS Items</Table.HeadCell>
        ...
        <Table.Body className="divide-y">
          {elementData?.elements.map((element, index) => (
            <Table.Row key={index} className="border-gray-700 bg-zinc-950">
              ...
              <Table.Cell className="text-gray-300">{element.referenceName}</Table.Cell>
              <Table.Cell className="text-gray-300">{element.numberItems.web}</Table.Cell>
              <Table.Cell className="text-gray-300">{element.numberItems.android}</Table.Cell>
              <Table.Cell className="text-gray-300">{element.numberItems.iOS}</Table.Cell>
