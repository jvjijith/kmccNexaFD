    ...
    return (
        <div className="flex w-full">
          ...
          .
            ...
            <div className="sm:flex-grow flex justify-between">
              <div className="">
                <div className="flex items-center">
                  <div className="text-3xl font-bold text-text-color">Product</div>
           ...
           <Card title={title}
           component={button?
            <button className="bg-secondary-card text-text-color px-4 py-2 rounded" onClick={() => navigate(`/product/add`)}>
              Add
            </button>:null
          }>
               {children}
