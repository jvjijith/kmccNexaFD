      ...
      <form onSubmit={handleSubmit}>
        {!(productId)&&
          ...
          <div className="w-full sm:w-1/2 p-4">
            <div className="mb-4">
              <label className="block w-full mb-2 text-text-color primary-text">Product *</label>
              <Select
        ...
        {priceData.pricing.map((price, pricingIndex) => (
          <div key={pricingIndex} className="flex flex-wrap">
            <div className="w-full sm:w-1/2 p-4">
              <div className="mb-4">
                <label className="block w-full mb-2 text-text-color primary-text">Amount *</label>
                <input
                  type="text"
                  name="amount"
            ...
            <div className="w-full sm:w-1/2 p-4">
              <div className="mb-4">
                <label className="block w-full mb-2 text-text-color primary-text">Currency *</label>
                <input
                  type="text"
                  name="currency"
                  className="block w-full h-10 px-2 py-1 border-b border-border secondary-card rounded-none focus:outline-none focus:border-white-500 transition text-text-color"
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              {price.rules.map((rule, ruleIndex) => (
                <div key={ruleIndex} className="flex mb-4">
                  {/* <label className="block w-full mb-2 text-text-color primary-text">Rule Type</label> */}
                  <input
                    type="text"
                    name="ruleType"
                  ...
                  />
                  {/* <label className="block w-full mb-2 text-text-color primary-text">Rule Country</label> */}
                  <input
                    type="text"
                    name="ruleCountry"
